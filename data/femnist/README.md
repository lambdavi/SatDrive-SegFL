# FEMNIST Dataset
Initial files and instructions from https://github.com/TalwalkarLab/leaf

## Setup Instructions
- conda install numpy
- conda install pillow
- Run ```./preprocess.sh``` with the following tags:<br/>
```./preprocess.sh -s niid --sf 1.0 -k 0 -t sample``` (full-sized dataset), where:
